...
<head>
    ...
    <link href="${ctx}/metronic/global/plugins/bootstrap-toastr/toastr.min.css" rel="stylesheet"
          type="text/css"/>
    <%--<link rel="stylesheet" type="text/css" href="${ctx}/css/bmap.css">--%>
    <link rel="stylesheet" type="text/css" href="${ctx}/bdoffline_v2.1/offlinemap/css/map.css">
...
<div id="hybrid" style="height: 600px;width:1100px;"></div>
...
<%--<script type="text/javascript" src="${ctx}/offlinemap/tools/DrawingManager_min.js"></script>--%>

<script type="text/javascript">
    /*//百度地图API配置
    var offmapcfg = {
        'imgext'      : '.jpg',   //瓦片图的后缀 ------ 根据需要修改，一般是 .png .jpg
        'tiles_dir'   : '/bdoffline_v2.1/offlinemap/tiles_hybrid/',       //普通瓦片图的地址，为空默认在 offlineemap/tiles/ 目录
    ...
    function  loadJScript() {
        ...
        script.type="text/javascript";
        script.src=_ctx+"/bdoffline_v2.1/offlinemap/map.js";
...
//            if(typeof init=='function'){
                createmap('hybrid', geoCoordMap,data);
//                init();
            }
        }
    }
...
function createmap(id,geoCoordMap,data) {

    $.getJSON(_ctx + '/map/json/china.json', function () {
...
//            bmap.addControl(new BMap.NavigationControl());
            bmap.setMaxZoom(8);
            bmap.setMinZoom(5);
           /* var b = new BMap.Bounds(new BMap.Point(62.564774, 1.678857),new BMap.Point(139.244707, 55.51742)); // 范围 左下角，右上角的点位置
